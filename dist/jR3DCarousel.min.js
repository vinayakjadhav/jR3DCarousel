...
a.controls&&h();a.navigation&&J();a.autoplay&&(x(),c.hover(function(){clearInterval(r)},function(){x()}));addEventListener("resize",B);B();var w=function(){var a,b={hidden:"visibilitychange",webkitHidden:"webkitvisibilitychange",mozHidden:"mozvisibilitychange",msHidden:"msvisibilitychange"};for(a in b)if(a in document){var c=b[a];break}return function(b){b&&document.addEventListener(c,b);return!document[a]}}();w(function(){w()&&a.autoplay?x():clearInterval(r)})})();w.prototype.run=function(a,b){this.animations[a](b)};
